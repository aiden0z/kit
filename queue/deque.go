...
//
// every operations over an Deque are synchronized and
// safe for concurrent usage.

var CapacityFullErr = errors.New("full capacity")
...
func (s *Deque) Append(item interface{}) error {
	s.Lock()
	defer s.Unlock()
